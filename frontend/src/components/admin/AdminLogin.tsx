  ...
  return (
    <div style={{
      ...
      background: isDark
        ...
        : 'linear-gradient(to bottom right, #fef2f2, #ffedd5)',
      display: 'flex',
      alignItems: 'center',
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <div style={{
              ...
              <Shield className="w-8 h-8" style={{ color: palette.red }} />
            </div>
            <h1 style={{ fontSize: '1.875rem', fontWeight: 700, color: colors.text, marginBottom: '0.5rem' }}>Admin Portal</h1>
            <p style={{ color: colors.muted }}>Sign in to manage your system</p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <a href="#" style={{ fontSize: '0.875rem', color: palette.red, textDecoration: 'none' }}>
                Forgot password?
              </a>
            </div>
